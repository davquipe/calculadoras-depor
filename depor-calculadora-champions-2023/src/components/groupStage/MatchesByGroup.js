                        ...
                        return (
                            <Fragment key={match.matchNumber}>                                   
                                ...
                                <article className="col-12 d-flex align-items-center justify-content-center mb-2 text-center">
                                    <span className="date-match">FECHA {dateMatch}</span>
                                </article>
                                <GroupStageTeam 
                                    group={group} 
                                    ...
                                    bgColor={getBgColor(match.matchDate, today, match.completedApi)}
                                ...
                                />                                    
                                <article className="col-12 d-flex align-items-center justify-content-center mb-2 text-center">
                                    <span className="match-data"><b>{matchStadium[0]}</b> / {matchStadium[1]} - {`${(match.matchDate).charAt(0).toUpperCase()}${(match.matchDate).slice(1)}`} - {match.matchHour}</span>
                                </article>
                            </Fragment>                    
                        )})
                    }
