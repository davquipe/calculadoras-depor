...
const StandingByGroup = props => {
    ...
    const getPositionColor = pos => {
        ...
        const positionColors = ['text-selected to-knockout-stage-team', 'text-selected to-knockout-stage-team', 'text-unselected eliminated-team', 'text-unselected eliminated-team']
