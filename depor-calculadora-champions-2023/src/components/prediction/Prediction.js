...
import { flagTeams, headers, idEntityApi, idPredictionParam, queryStrStart, responseStatusOk, socialShareText, twitterAccount, urlEspecial, urlFlags } from '../../Constants';
                ...
                loading
                    ...
                    : <>
                        ...
                        <section className="my-3 px-2">
                            <Champion flagTeams={flagTeams} name={`¡${userChampion} CAMPEÓN!`} slugFlag={userSlugFlag} urlFlags={urlFlags} />
                        </section>
