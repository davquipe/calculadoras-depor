...
const MatchDays = ({
  ...
  const separatedMatchDays = chunkArray(matchDays, 11);
              ...
              <section className="d-flex justify-content-start mx-auto px-4">
                {sepMatchDays.map((sMatchDay) => (
                  <Button
                    key={sMatchDay}
                    bsPrefix={"-"}
                    className={`me-1 btn-matchday ${
                      parseInt(sMatchDay) === activeMatchDay
                        ? "active-match-day"
                        : ""
                    }`}
                    type="button"
                    onClick={() =>
                      handleChangeActiveMatchDay(parseInt(sMatchDay))
                    }
                  >
                    {sMatchDay}
                  </Button>
